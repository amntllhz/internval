...
@section('content')
    <section class="lg:max-w-5xl lg:bg-gradient-to-b lg:from-white lg:to-white xs:bg-gradient-to-b xs:from-apple-400 xs:to-apple-700 xs:w-full mx-auto flex flex-col lg:justify-center lg:items-center xs:justify-between xs:items-end min-h-screen">
        <div class="relative flex lg:p-2 xs:p-0 lg:flex-row xs:flex-col lg:w-fit xs:w-full lg:justify-center xs:justify-between lg:gap-6 xs:gap-0 items-center rounded-2xl mx-auto lg:h-fit xs:min-h-screen">

            {{-- Masuk sebagai --}}
            <div class="flex relative xs:bg-gradient-to-b xs:from-transparent xs:to-transparent lg:bg-gradient-to-b lg:from-apple-400 lg:to-apple-600 overflow-hidden flex-col lg:h-64 xs:h-full lg:p-0 xs:p-0 lg:rounded-xl xs:rounded-t-2xl xs:rounded-b-none lg:justify-center lg:items-center xs:justify-start xs:items-start xs:grow">                
            ...
            <div class="lg:relative lg:bg-white lg:ring-0 xs:rounded-t-4xl xs:bg-transparent lg:w-fit xs:w-full flex flex-col space-y-1 px-6 lg:py-6 xs:py-8 items-center justify-center">
                ...
                <a href={{ route('mahasiswa.redirect') }} class="lg:text-white xs:text-apple-600 flex justify-center items-center gap-2 font-display font-bold bg-gradient-to-b lg:from-apple-600 lg:to-apple-700 xs:from-white xs:to-white lg:hover:from-apple-700 lg:hover:to-apple-900 xs:hover:from-white xs:hover:to-white transition duration-300 ease-in-out px-4 py-2 lg:text-xs xs:text-sm rounded-md lg:w-56 xs:w-full text-center cursor-pointer">
                ...
                <div class="w-full flex justify-center xs:flex-row lg:gap-2 xs:gap-4">
                    <a href="/admin/login" class="flex justify-center items-center gap-2 lg:text-gray-500 xs:text-white font-display font-bold lg:bg-gray-200 xs:bg-transparent lg:hover:bg-gray-300 xs:hover:bg-white/30 lg:hover:text-white xs:ring xs:ring-white transition duration-300 ease-in-out px-4 py-2 lg:text-xs xs:text-sm rounded-md lg:w-[108px] xs:w-full text-center">
