    ...
    <section class="lg:max-w-5xl xs:max-w-9/10 w-full mx-auto flex flex-col justify-center items-center min-h-screen">
        <div class="relative flex p-2 lg:flex-row xs:flex-col max-w-5xl justify-center lg:gap-6 xs:gap-4 items-center bg-white rounded-2xl mx-auto">
            ...
            <div class="flex relative overflow-hidden flex-col h-full lg:p-0 xs:p-8 lg:rounded-xl xs:rounded-t-2xl xs:rounded-b-none justify-center items-center">                
                ...
                <img id="getstarted" src="{{ asset('img/sample.svg') }}" alt="getstarted" class="w-[360px]">
            </div>
            ...
            <div class="relative flex flex-col space-y-1 lg:p-6 xs:p-2 items-center justify-center">
                ...
                <a href={{ route('mahasiswa.redirect') }} class="text-white flex justify-center items-center gap-2 font-display font-bold bg-gradient-to-b from-apple-600 to-apple-700 hover:from-apple-700 hover:to-apple-900 transition duration-300 ease-in-out px-4 py-2 text-xs rounded-md lg:w-56 xs:w-56 text-center">
                ...
                <div class="w-full flex lg:justify-between xs:flex-row xs:gap-2">
                    <a href="/admin/login" class="flex justify-center items-center gap-2 text-gray-500 font-display font-bold bg-gray-200 hover:bg-gray-300 hover:text-white transition duration-300 ease-in-out px-4 py-2 text-xs rounded-md lg:w-[108px] xs:w-27 text-center">
