<section class="lg:max-w-5xl xs:max-w-9/10 w-full mx-auto flex flex-col justify-center items-center h-screen">
    ...
    <div class="mt-6 bg-apple-100 rounded-full flex justify-center items-center p-2 gap-4">
        <a href="" class="text-white font-display font-bold bg-gradient-to-b from-apple-600 to-apple-700 hover:from-apple-700 hover:to-apple-900 transition duration-300 ease-in-out px-4 py-2 text-sm rounded-full">Get Started</a>
        <a href="" class="text-gray-700 font-display font-bold bg-apple-50 hover:bg-apple-300 transition duration-300 ease-in-out px-4 py-2 text-sm rounded-full">Read Docs</a>
    </div>
</section>