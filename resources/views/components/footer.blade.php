          ...
          <div class="flex flex-row gap-x-4">
            ...
            <a href="#" class="group">
              <div class="relative bg-apple-100/10 backdrop-blur-xs rounded-lg flex-col py-6 px-6 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute bottom-3 left-3 size-6 text-white group-hover:size-5 group-hover:transform group-hover:bottom-4 group-hover:left-3.5 duration-200 ease-in-out">
